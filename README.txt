1. Proceso de creacion repositorio local
	1.1. Crear directorio local para el repositorio (intro-git)
...
2. Adicionar archivos al repositorio
	2.1. Crear nuevo archivo de texto (README.txt)
	2.2. Adicionar archivo al área de trabajo (comando git add) => git add README.txt
...
3. Subir repositorio remoto
	...
	3.2. Enlazar repositorio local con repositorio remoto (git remote add origin https://github.com/aapinzonr/intro-git.git)
